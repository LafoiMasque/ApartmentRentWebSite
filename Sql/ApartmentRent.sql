...
--微信与平台的一个ID add 20180705 vidic
OpendId VARCHAR(32) not NULL,
--房东名称
...
-- 租客与房间关系表
CREATE TABLE RenterRoomRelation
(
--Id
RelationId UNIQUEIDENTIFIER NOT NULL PRIMARY KEY,
--租客Id
...
--网费 add 20180705 vidic
NetAmount NUMERIC(10,2),
--其他固定费用 add 20180705 vidic
...
--0 现金 2微信支付  4支付宝 8网银转账 4其他
CREATE TABLE PayTypeInfo
(
--类型编号
TypeCode TINYINT PRIMARY KEY,
--说明
...
--积分异动 add vidic 20180705
CREATE TABLE PonintsChange
(
--租客Id
RenterId UNIQUEIDENTIFIER NOT NULL PRIMARY KEY,
--积分活动Id
