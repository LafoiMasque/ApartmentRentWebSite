...
namespace LafoiApp.Core
{
	public class MemcacheHelper
	{
		private static MemcachedClient m_memcachedClient = null;
		
		/// <summary>
		/// 最好放在配置文件中
		/// localIP = ComputerHelper.GetLocalIP();
		/// serverList = { localIP + ":11211", "10.0.0.137:11211" };
		/// </summary>
		/// <param name="serverList"></param>
		public static void InitMemcached(string[] serverList)
		{
			//初始化池
