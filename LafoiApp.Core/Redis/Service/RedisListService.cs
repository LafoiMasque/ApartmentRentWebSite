...
namespace LafoiApp.Core.Redis.Service
{
	...
	public class RedisListService : RedisBase
    {
        ...
        {
            return RedisClient.GetRangeFromList(key, star, end);
        }
        ...
        {
            return RedisClient.BlockingDequeueItemFromList(key, sp);
        }
        ...
        {
            return RedisClient.BlockingPopItemFromLists(keys, sp);
        }
        ...
        {
            return RedisClient.BlockingDequeueItemFromLists(keys, sp);
        }
        ...
        {
            return RedisClient.BlockingRemoveStartFromLists(keys, sp);
        }
        ...
        {
            return RedisClient.RemoveItemFromList(key, value);
        }
