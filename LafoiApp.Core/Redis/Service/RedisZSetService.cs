...
namespace LafoiApp.Core.Redis.Service
{
	/// <summary>
	...
	public class RedisZSetService : RedisBase
    {
        ...
        {
            return RedisClient.GetSortedSetCount(key, fromScore, toScore);
        }
        ...
        {
            return RedisClient.GetRangeFromSortedSetByLowestScore(key, fromscore, toscore);
        }
        ...
        {
            return RedisClient.GetRangeWithScoresFromSortedSetByHighestScore(key, fromscore, toscore);
        }
        ...
        {
            return RedisClient.GetRangeFromSortedSetDesc(key, fromRank, toRank);
        }
        ...
        {
            return RedisClient.GetRangeWithScoresFromSortedSet(key, fromRank, toRank);
        }
